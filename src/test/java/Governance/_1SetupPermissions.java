...
//#Permission on Resource Instances
public class _1SetupPermissions {
	HttpClient client;
	HttpPost httpPost;
	HttpPut httpPut;
	...
	@Test
	public void SetupPermissionsObjectsApplications() throws ClientProtocolException, IOException {
		thisMethodName = "SetupPermissionsObjects";
		httpPost = new HttpPost("http://10.10.8.32:8080/AppCenter/services/rest"
				+ "/permission/assign"
				+ "?entity=Applications"
				+ "&instanceName=FluentXenApplicationOnSecurityGroup"
				+ "&isGroup=true"
				+ "&accessorName=FluentMaxGroup");
		String json = "{\"accessPermission\":\"true\","
